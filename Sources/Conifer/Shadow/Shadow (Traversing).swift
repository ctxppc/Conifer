...
extension Shadow {
	...
	public var directParent: (any Shadow)? {
		get async throws {
	...
	///
	/// The children may be foundational components. For the nearest non-foundational descendant components, use `children()` instead.
	public func directChildren() async throws -> some Sequence<any Shadow> {
