...
public protocol MutableDynamicProperty : DynamicProperty where Value : Sendable {
	...
	///
	/// As `wrappedValue` can only change between rendering cycles, `wrappedValue` is unchanged immediately after this method returns. It might be equal to `value` in the rendering cycle.
	///
